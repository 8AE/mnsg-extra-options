...
| Hyper Enemies | Disabled | Gives supported enemies, enemy obstacles, and boss controllers 4x movement and attack cadence (2.5x average for Tsurami) while retaining their native physics and collision processing. |
